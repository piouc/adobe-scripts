...
if (!Array.prototype.every) {
  Array.prototype.every = function (callback, thisArg) {
    ...
    T = arguments.length > 1 ? thisArg : void 0; // 6. Let k be 0.
    ...
    while (k < len) {
      ...
      if (k in O) {
        ...
        var testResult = callback.call(T, kValue, k, O); // iii. If ToBoolean(testResult) is false, return false.
...
if (!Array.prototype.forEach) {
  Array.prototype.forEach = function (callback, thisArg) {
    ...
    var T = arguments.length > 1 ? thisArg : void 0; // 6. Let k be 0
    //k = 0;
...
if (!Array.prototype.map) {
  Array.prototype.map = function (callback, thisArg) {
    ...
    T = arguments.length > 1 ? thisArg : void 0; // 6. Let A be a new array created as if by the expression new Array(len) 
...
if (!Object.create) {
  ...
  Object.create = function () {
    ...
    function Temp() {} // make a safe reference to Object.prototype.hasOwnProperty
...
!function() {
/*!**********************************!*\
  !*** ./src/add-artboard-name.ts ***!
  \**********************************/
/// <reference types="types-for-adobe/Illustrator/2015.3"/>
var rgb = function rgb(_rgb) {
  var _rgb$r, _rgb$g, _rgb$b;

  var color = new RGBColor();
  color.red = (_rgb$r = _rgb.r) != null ? _rgb$r : 0;
  color.green = (_rgb$g = _rgb.g) != null ? _rgb$g : 0;
  color.blue = (_rgb$b = _rgb.b) != null ? _rgb$b : 0;
  return color;
};

(function () {
  var doc = app.activeDocument;
  var artboards = Array.from(doc.artboards);
  artboards.forEach(function (artbord) {
    var text = doc.textFrames.add();
    var rect = artbord.artboardRect;
    text.contents = artbord.name + " " + Math.round(rect[2] - rect[0]) + "x" + Math.round(rect[1] - rect[3]);
    text.textRange.characterAttributes.size = 40;
    text.textRange.characterAttributes.fillColor = rgb({
      r: 255,
      g: 255,
      b: 255
    });
